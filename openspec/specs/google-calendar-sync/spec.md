...
Per-psychologist Google Calendar connection: one-way export of Trigger sessions to the primary calendar (create/update/delete) and import of busy intervals into booking slot availability.
