...
The public, unauthenticated side of Trigger: the psychologist's booking page at their slug URL, booking submission without a client account, the session lifecycle managed by the psychologist (confirm/cancel/reschedule), and the public session status page.
