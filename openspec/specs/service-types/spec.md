...
The psychologist's service catalog: named service types with per-service slot duration, break (included within the slot), and price; exactly one default service per psychologist; migration semantics for pre-service accounts.
