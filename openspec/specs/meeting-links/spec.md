...
Automatic video meeting links for confirmed sessions: per-psychologist provider connections (Zoom via OAuth; Google Meet via the Calendar connection), a pluggable provider architecture, and delivery of the join link to both parties.
