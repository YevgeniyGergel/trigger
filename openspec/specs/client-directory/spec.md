...
The psychologist's client card index: creating client records (manually or from public bookings), viewing session history, editing and deactivating clients. Clients have no login.
